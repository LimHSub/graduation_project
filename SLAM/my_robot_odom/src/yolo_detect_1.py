...
class YoloObjectTFDetector:
    def __init__(self):
        ...
        self.target_offset_x = float(rospy.get_param("~target_offset_x", -0.05))
        ...
        self.button_state_after_push_timeout = float(rospy.get_param("~button_state_after_push_timeout", 30.0))
